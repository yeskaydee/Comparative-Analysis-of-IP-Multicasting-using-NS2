...
#Trace-file
set tf [open trace_ctrmcast_15n.tr w]
$ns trace-all $tf

#Animation-file
set nf [open animation_ctrmcast_15n.nam w]
$ns namtrace-all $nf
set f0 [open bytes_c_15_n.txt w]
...
close $tf
close $nf
exec nam animation_ctrmcast_15n.nam &
exit 0
}
