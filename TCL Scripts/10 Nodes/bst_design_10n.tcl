...
#Trace-file
set tf [open trace_bst.tr w]
$ns trace-all $tf

#Animation-file
set nf [open animation_bst.nam w]
$ns namtrace-all $nf
set f0 [open bytes_b_10_n.tr w]
...
$ns at 4.5 "$n3 label \"RP-G1 \""
$ns at 5.0 "$n5 leave-group $rcvr2 $group1"
$ns at 5.0 "$n5 label \"RP-G3 \""
